...
import com.example.foodstore.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        if (list.get(position).getType().equals("egg")){
            holder.price.setText(String.valueOf(list.get(position).getPrice())+"/dozen");
        }
        if (list.get(position).getType().equals("fastfood")){
            holder.price.setText(String.valueOf(list.get(position).getPrice())+"/item");
        }
