...
public class ProfileFragment extends Fragment {
    ...
    private static final int REQUEST_CODE_LOCATION = 55;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //checking permissions and requesting for camera
        ...
        //checking permissions and requesting for geolocations
                ...
                fusedLocationClient.getLastLocation()
                        .addOnSuccessListener(new OnSuccessListener<Location>() {
                            ...
                            public void onSuccess(Location location) {
                                if (location != null) {
                                    //using geocoder to get the address from the coordinates
